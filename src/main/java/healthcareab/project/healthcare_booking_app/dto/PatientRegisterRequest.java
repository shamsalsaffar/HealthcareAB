...
public class PatientRegisterRequest {
    ...
    @Pattern(
            ...
            message = "First name can only include alphabetic characters, spaces, hyphens, and apostrophes."
    )
    ...
    @Pattern(
            regexp = "^[A-Za-z]+(?:[ '-][A-Za-z]+)*$",
            message = "Last name can only include alphabetic characters, spaces, hyphens, and apostrophes."
    )
    ...
    public PatientRegisterRequest(String username, String password, String firstName, String lastName,
