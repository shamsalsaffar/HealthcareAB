...
public class Patient extends User {
    ...
    public Patient(String username, String password, Role role, String adress, String phoneNumber, String personalIdentityNumber) {
    ...
    public void setAdress(@NotNull(message = "Adress can not be empty") @Size(max = 100, message = "Your adress can not exceed 100 symbols") String adress) {
        this.adress = adress;
    }
    ...
    public @Pattern(
            regexp = "^(19|20)\\d{2}(0[1-9]|1[0-2])(0[1-9]|[12]\\d|3[01])\\d{4}$",
            message = "Invalid personal identity number (YYYYMMDDXXXX)"
    ) @NotNull(message = "Personal identity number cannot be empty") String getPersonalIdentityNumber() {
        return personalIdentityNumber;
    }

    public void setPersonalIdentityNumber(@Pattern(
            regexp = "^(19|20)\\d{2}(0[1-9]|1[0-2])(0[1-9]|[12]\\d|3[01])\\d{4}$",
            message = "Invalid personal identity number (YYYYMMDDXXXX)"
    ) @NotNull(message = "Personal identity number cannot be empty") String personalIdentityNumber) {
        this.personalIdentityNumber = personalIdentityNumber;
    }
}
